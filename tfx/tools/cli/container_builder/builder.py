...
class ContainerBuilder(object):
  ...
  def __init__(self,
               ...
               buildspec_filename: Optional[Text] = commons.BUILD_SPEC_FILENAME,
               dockerfile_name: Optional[Text] = commons.DOCKERFILE_NAME,
               setup_py_filename: Optional[Text] = commons.SETUP_PY_FILENAME):
    """Initialization.
    ...
    """
    self._buildspec = buildspec.BuildSpec(
